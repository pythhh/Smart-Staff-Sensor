...
### 🔧 How to use ?
เมื่อมีวัตถุเข้ามาใกล้กับตัวsersonน้อยกว่า 50 เซนติเมตรจะมีเสียงแจ้งเตือนเพื่อให้ผู้พิการทางสายตาให้ระวังข้างหน้าพื้นแต่สามารถข้ามได้ เช่น ฟุตบาทหรือบันได<br>
![](img/down.gif)<br>
เมื่อมีวัตถุเข้ามาใกล้กับตัวsersonน้อยกว่า 150 เซนติเมตรจะมีเสียงแจ้งเตือนเพื่อให้ผู้พิการทางสายตาให้ระวังด้านหน้าที่เป็นแนวขนานผู้ใช้ เช่น กำแพงหรือคน<br>
![](img/up.gif)
